      ...
      <div className="container-fluid header position-relative">
        ...
        <NavbarBrand className="" href="/">
          <NavLink to="/home" style={{ textDecoration: "none" }}>
            <img
              className="logo"
              src="https://img.icons8.com/external-flat-geotatah/64/000000/external-community-corporate-social-responsibility-flat-flat-geotatah.png"
              height="70"
              width="70"
            />
            <span className="h3 fw-bold mb-0" style={{ color: "#3f75cf" }}>
              CSR HUB
            </span>
          </NavLink>
        </NavbarBrand>
        <div className="setpot">
          <Collapse isOpen={isNavOpen} navbar>
            <Nav navbar>
              ...
              <div
                className={
                  path == "/signIn" || user.signIn == true ? "d-none" : ""
                }
              >
                <NavItem>
              ...
              <div
                className={user.signIn == true ? "d-inline-block" : "d-none"}
              >
                <NavItem>
                  <NavLink
                    className="nav-link"
                  ...
                  <div
                    className={"tool_bar " + (isToolOpen == true ? "open" : "")}
                  >
                    <NavLink className="nav-link tool_item" to="/profile">
                      Profile
                    </NavLink>
                    <NavLink className="nav-link tool_item" to="/post">
                      Post a project
                    </NavLink>
                    <NavLink
                      onClick={handleClickOut}
                      className="nav-link tool_item"
                      to="/home"
                    >
                      Sign up
                    </NavLink>
